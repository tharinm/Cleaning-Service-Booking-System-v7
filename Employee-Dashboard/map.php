...
<html lang='en'>
   <head>
      ...
      <script defer src="https://maps.googleapis.com/maps/api/js?libraries=places&key=AIzaSyBNcVw0yN-VK3Nx9coS9JspyBr2gcn_hX8" type="text/javascript"></script>
      ...
      <div class='navbar navbar-default navbar-static-top heading_anchor' >
         <div class='container-fluid'>
            <div class="navbar-header">
               ...
               <a class='navbar-brand heading_anchor ' href='#'><b>Search on Map</b></a>
            </div>
            ...
            <div class='col-md-4'>
               ...
               <div class='well define_height'>
                  <form id="distance_form">
                     ...
                     <input class="btn btn-primary" type="submit" value="Find" style="background: #008AFF; width: 100%; height: 50px; border: 0px;" />
                  </form>
